...
//     System.out.println("key"+arg0);
     while (productsWithCount.hasNext()) {
    	 ...
    	 int currentRating=Integer.parseInt(values[2].trim());
    	 ...
    	 else if(maxRating<currentRating&&currentScore==maxCount)
    	 {
    		 mostSuggestedProducts = new StringBuilder();
    		 mostSuggestedProducts.append(currentSuggestedProduct);
    		 maxCount= currentScore;
    	 ...
    	 else if(currentScore==maxCount&&maxRating==currentRating&&similarityCount<6)
    	 {
    		 similarityCount++;
    		 mostSuggestedProducts.append(","+currentSuggestedProduct);
